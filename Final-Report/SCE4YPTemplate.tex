...
\section{Proposed Solution} \label{proposed-solution}se
%TODO: Pulled with slight modification from proposal, needs more editing probably
...
% TODO: Need at least one diagram/picture between here and JQuery section
...
%TODO: screenshot of the HTML and the rendered page beside each other
...
% TODO: Maybe reference the diagram better, or provide more explanation of it
...
primary key. Figure~\ref{fig:db-tables} shows the tables of our database, and their relationships.
...
% TODO add ref to section when it is written
