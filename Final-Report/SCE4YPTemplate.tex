...
single-board microcontroller, and a Integrated Development Environment for writing Arduino code~\ref{WHATISARDUINO}. 
...
\begin{figure}
    ...
    \caption{Inside view of the end unit demonstration}
    \label{fig:end-unit-inside}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{Diagrams/end_unit_outside}
    \caption{Outside view of the end unit demonstration}
    \label{fig:end-unit-outside}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{Diagrams/end_unit_leds}
    \caption{Outside view of the end unit demonstration, focused on the LEDs and NFC module}
