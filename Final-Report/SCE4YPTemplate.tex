...
\begin{figure}
    \includegraphics[width=\textwidth]{Diagrams/modules_start}
...
Front Controller pattern can be seen in Figure~\ref{fig:front-controller}.

\begin{figure}
    \includegraphics[width=\textwidth]{Diagrams/Server_Diagrams/Front-Controller.png}
    \caption{Front Controller Class Diagram}
    \label{fig:front-controller}
\end{figure}

Facade pattern can be seen in Figure~\ref{fig:facade-server}. Facade functionality is shown
through the sequence diagram in Figure~\ref{fig:facade-signup-sequence}.

\begin{figure}
    \includegraphics[width=\textwidth]{Diagrams/Server_Diagrams/Facade.png}
    \caption{Facade Class Diagram}
    \label{fig:facade-server}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{Diagrams/Server_Diagrams/Facade_SignUpSequence.png}
    \caption{Facade - Sign Up Sequence Diagram}
    \label{fig:facade-signup-sequence}
\end{figure}
