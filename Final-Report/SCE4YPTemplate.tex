...
The requirements of our system from the use cases described in chapter~\ref{business-use-cases} led us to a simple
...
This list was configured with an Adapter class which extends the general ArrayAdapter\textless T\textgreater ~ class. These adapters were
