...
%TODO: Having the 5 USD looks a little odd
...
microcontroller, and a Integrated Development Environment. The platform's popularity stems from its low difficulty, as 
only a USB cable is required to program the board. Some varieties of microcontroller require a separate piece of 
hardware, called a programmer, to run. Arduino can be used to accomplish a variety of small tasks, from driving a PIN 
button matrix, to reading temperature sensors, to running motors.
...
{fig:hardware-block} is a block diagram of the initial design architecture of the lock software, including the 
potential design patterns that the classes should use.
...
\begin{figure}
    ...
    \caption{Inside of the end unit demonstration}
...
``kickback current" to oppose a change in current. % TODO: cite this
...
\begin{figure}
    \centering
    \includegraphics{Diagrams/Hardware-Diagrams/hardware_class_group3}
...
\begin{figure}
    \centering
    \includegraphics{Diagrams/Hardware-Diagrams/hardware_class_group4}
    \caption{Hardware abstraction classes}
...
% TODO: Write a short paragraph explaining why I put this sequence chart here
Figure~\ref{fig:hardware-interaction-sequence}
...
%TODO: continous integration, delivery. Also have NFC tag instead of reader to simplify hardware (cheaper)
