...
% TODO: For Facade section, modify the signup sequence diagram to match the process described,
	%	and show/mention the diagram in the paragraph
...
class diagram of how the SignupController interacts with multiple other controllers. The SignupController
will call the UserController
