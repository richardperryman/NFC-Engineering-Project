...
% TODO for Jess: Investigate if "design pattern" should be changed to "behavioural pattern", roll the debugging hardware stuff into the testing hardware stuff
