...
% TODO: Put diagram of the tables somewhere in this section and reference it in 1NF paragraph
...
% Was going to have sequence diagram, but while making it I realized it was a bit too complicated
	% So I will most likely leave it out, unless I can simplify it significantly
...
% TODO: Facade reference: Try library for the patterns book
...
design patterns mentioned in section~\ref{lock-control-software-design} could 

\subsection{Authentication Module Implementations} \label{authentication-modules-implementations}

The authentication modules in this project were powered by 
