...
dramatically impact user experience, while also ensuring that brute forcing was too inefficient.
...
\begin{table}[!h]
	...
	\begin{tabular}{| r | r |}
		...
		1000000 & 12777 \\ \hline
	\end{tabular}
	\caption{Table of time taken to perform SHA256 password based key derivation}
