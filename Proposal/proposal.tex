...
% Needs better title - also may not need to be subsections? (J: This title has grown on me lol)
% Jess
...
% Tentative addition of tracking stuff - maybe should be more in previous section, then just fleshed out a bit here?
...
% Maybe this should be moved to Central Mail?
...
\begin{ganttchart}[
	...
	\ganttbar{Preliminary design}{3}{8} \\
	\ganttbar{Preliminary testing}{8}{11} \\
	\ganttbar{Preliminary integration}{12}{15} \\
	\ganttbar{Progress report}{12}{13}
\end{ganttchart}
\end{figure}
% J: Not sure if I should include figure numbers for the Gantt charts?
...
\begin{ganttchart}[
	...
	\ganttbar{System testing}{6}{9} \\
	\ganttbar{Oral presentation}{4}{4} \\
	\ganttbar{Poster fair}{11}{12} \\
	\ganttbar{Draft final report}{9}{12} \\
